...
- e2c7eee8: Refactored Backoffice authorization checks to provide consistent permission handling for service creation and subscription/API key management, including a fix for authorization errors affecting operators without groups.
...
- Updated dependencies [9b7a6d5c]
  - @io-services-cms/external-clients@1.12.1
...
- 2d2f3cd4: fourth update Selfcare OpenAPI json file
...
- 9a41c3f2: second update Selfcare OpenAPI json file
