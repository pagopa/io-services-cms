...
const aServiceLifecycleItem: ServiceLifecycle.ItemType = {
  ...
  data: {
    ...
    metadata: {
      ...
      appAndroid: aLegacyService.serviceMetadata?.appAndroid,
      appIos: aLegacyService.serviceMetadata?.appIos,
      ...
      privacyUrl: aLegacyService.serviceMetadata?.privacyUrl,
      supportUrl: aLegacyService.serviceMetadata?.supportUrl,
      tokenName: aLegacyService.serviceMetadata?.tokenName,
      tosUrl: aLegacyService.serviceMetadata?.tosUrl,
      webUrl: aLegacyService.serviceMetadata?.webUrl,
    },
