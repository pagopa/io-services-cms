...
describe("On Service Detail Publication Change Handler", () => {
  it.each`
    ...
    ${"request-detail-publication (unpublished)"}      | ${{ ...aService, fsm: { state: "unpublished" }, _ts: aCosmosResouceTs, modified_at: aModifiedAt }} | ${{ requestDetailPublication: { ...aService, fsm: { state: "unpublished" }, kind: "publication", cms_last_update_ts: aModifiedAt } }}
