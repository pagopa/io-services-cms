locals {
  repository = {
    ...
    topics                   = ["services-cms"]
    reviewers_teams          = ["io-institutions-n-services", "engineering-team-devex", "io-foundation-identity-n-access-backend", "io-foundation-identity-n-access-frontend", "io-communication-backend"]
