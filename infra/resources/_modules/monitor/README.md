...
| <a name="input_key_vault"></a> [key\_vault](#input\_key\_vault) | Azure KeyVault references | <pre>object({<br/>    id = string<br/>    secrets_name = object({<br/>      slack_svc_monitor_webhook_url = string<br/>    })<br/>  })</pre> | n/a | yes |
