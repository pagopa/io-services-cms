...
module "backoffice_app" {
  source = "github.com/pagopa/terraform-azurerm-v3.git//app_service?ref=v7.44.0"
...
module "backoffice_app_staging" {
  source = "github.com/pagopa/terraform-azurerm-v3.git//app_service_slot?ref=v7.44.0"
