...
locals {
  webapp_functions_app_settings = {
    ...
    COSMOSDB_CONTAINER_SERVICE_LIFECYCLE   = local.cosmos_containers.services_lifecycle
    COSMOSDB_CONTAINER_SERVICE_PUBLICATION = local.cosmos_containers.services_publication
